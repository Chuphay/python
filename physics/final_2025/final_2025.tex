...
To complete our framework, we now introduce the textbf{zero-point radiation field}. Following the ideas of stochastic electrodynamics (SED), we assume that the vacuum is filled with a classical, Lorentz-invariant electromagnetic radiation field even at absolute zero. 

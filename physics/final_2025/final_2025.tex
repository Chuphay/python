...
Now, imagine we place this ball in the vacuum of deep space. As it cools, it emits infrared photons, gradually losing energy to its surroundings. The glow fades as the ball approaches absolute zero.
...
This is not a free assumption. In later sections, we will show how this momentum field arises from boundary conditions at the mass’s surface, and how the coefficient (including \( \hbar \)) follows from coupling to the zero-point background radiation.

...
\textbf{Productive:}  understanding that sometimes (most of the time) a proof is much more interesting and useful than what it is proving was something I definitely noticed happen as I developed more mathematical maturity.
Here’s the other feature of proof: it leads you to discover things you might not have known about.
...
Hilbert was in the audience of Einstein’s lectures at Göttingen on General Relativity in 1915. Einstein presented his progress in the new theory and the difficulties he was having with making his field equations generally covariant (i.e. independent of their coordinate system). Later Hilbert published the equations ‘five days before’, than Albert Einstein-the man who has worked almost a decade extensively on this. (See General relativity priority dispute - Wikipedia)
\\[0.1in]
When Andrew Wiles corrected the error he made in the proof of Fermat's Last Theorem, did the proof become much simpler?
No. The error was fundamental, and he needed to take a completely different approach - in fact he resurrected an approach he abandoned years earlier, thanks to an insight that came out, Phoenix-style, from the very obstacle that ruined his original proof.

But to the best of my knowledge, the new and correct proof was not in any way simpler than the original. In fact it required another layer of new ideas and a second paper, co-authored with Richard Taylor.
\\[0.2in]
